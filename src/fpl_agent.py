...
class Agent:
    ...
    def get_gemini_response(self, question, prompt):
        response = self.model.generate_content([prompt[0], question])
        return response.text
    
    # TODO: response cleaning (make it a clan sql query)
...
if __name__ == '__main__':
    ...
    prompt=[
        ...
        <prompt>
            <description>
                You are a SQL generator that creates accurate, efficient SQL queries based on user instructions. The schema below belongs to a database used for analyzing Fantasy Premier League data.
            </description>
            <schema>
            ...
            <instructions>
                <point>Create a valid SQL query based on user instructions.</point>
            ...
            <example>
                <request>Get the total points scored by all players in gameweek 1 of the 2023 season.</request>
                <sql><![CDATA[
            SELECT 
                pp.player_name,
            ...
            JOIN 
                dbt_ohempel.dim_gameweeks AS gw
                ON pp.gameweek_id = gw.gameweek_id
            JOIN 
